...
public class Complex extends Number 
  ...
  public  final Complex I = new Complex(ZERO, ONE);
  public  final Complex nI = new Complex(ZERO, NONE);
  public  final Complex e = new Complex(StrictMath.E, ZERO);
  public  final long INFINITE = Long.MAX_VALUE;
   ...
   * @return
   */
  public  Complex pow(Complex z, Complex y)
  {
    double c = y.real();
    double d = y.imag();
